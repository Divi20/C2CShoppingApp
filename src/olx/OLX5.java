 ...
 * OLX5.java
 *
 * Created on Oct 30, 2014, 10:12:12 AM
 */
 ...
 * @author Machine38
 */
public class OLX5 extends javax.swing.JFrame {

    /** Creates new form OLX5 */
    public OLX5() {
        initComponents();
    }
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)))
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(t9, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
                            .addComponent(t8, javax.swing.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(t6, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
                                .addComponent(t7))))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(64, 64, 64)
                        .addComponent(submit)))
        ...
        ch2.setForeground(new java.awt.Color(0, 102, 102));
        ch2.setText("CLICK ME IF YOU WANT TO CONFIRM");
        ...
        r2.setText("YOU WANT TO PURCHASE");
        ...
        jLabel1.setText("^-^  S H O P  ^-^");

        r1.setForeground(new java.awt.Color(0, 102, 102));
        r1.setText("YOU WANT TO SALE ");
        ...
        l21.setForeground(new java.awt.Color(0, 102, 102));
        l21.setText("ENTER URL");
        l21.setEnabled(false);

        t1.setEnabled(false);

        ch1.setForeground(new java.awt.Color(0, 102, 102));
        ch1.setText("DONE");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(l21, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(62, 62, 62)
                        .addComponent(ch1)))
        ...
        l12.setForeground(new java.awt.Color(0, 102, 102));
        l12.setText("PRICE");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(t3, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE)
                            .addComponent(t4, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE)
                            .addComponent(t12, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE)
                            .addComponent(t5, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE)
                            .addComponent(t2, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE)
                            .addComponent(t11, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE)))
        ...
        l10.setForeground(new java.awt.Color(0, 102, 102));
        l10.setText("ENTER TYPE");
        l10.setEnabled(false);

        t10.setEnabled(false);

        l22.setForeground(new java.awt.Color(0, 102, 102));
        l22.setText("SEARCH BY");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(72, 72, 72)
                        .addComponent(ch2, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())))
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGap(254, 254, 254)
...
l10.setEnabled(false);
        t10.setEnabled(false);
        l22.setEnabled(false);cb1.setEnabled(false);
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        String c=t4.getText();
         ...
         int g=Integer.parseInt(t8.getText());
         String h=t9.getText();
         String n=t1.getText();
         try
         {
             ...
             String z="insert into c2c values("+y+",'"+a+"','"+b+"',"+s+",'"+c+"','"+d+"','"+t+"','"+f+"','"+g+"','"+h+"','"+n+"');";
            
            st.executeUpdate(z);

           JOptionPane.showMessageDialog(null,"your product id is"+y+"");
    ...
    private void jRadioButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton1ActionPerformed
        // TODO add your handling code here:
                  ...
                  try
         {
             ...
             String s="select count(*) from c2c";
  ...
  int g=rs.getInt(1);
    ...
    private void r2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_r2ActionPerformed
        ...
        l10.setEnabled(true);
        t10.setEnabled(true);
        l22.setEnabled(true);cb1.setEnabled(true);
         l21.setEnabled(false);
        t1.setEnabled(false);
        ch1.setEnabled(false);
        submit.setEnabled(false);
    ...
    private void l22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_l22ActionPerformed
        ...
        DefaultComboBoxModel md=(DefaultComboBoxModel)cb1.getModel();
                  try
         {
             ...
             String s="select pname from c2c where ptype='"+a+"';";
            ResultSet rs= st.executeQuery(s);
                  while(rs.next()){


            String g=rs.getString("pname");
            md.addElement(g);
    ...
    private void cb1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb1ActionPerformed
        ...
        String k = (String)md.getSelectedItem();
         try
         {
             ...
             String s="select * from c2c where pname='"+k+"';";
            ResultSet rs= st.executeQuery(s);
                  while(rs.next()){
int a=rs.getInt(1);
